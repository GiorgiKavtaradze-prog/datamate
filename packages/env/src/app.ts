...
//
// Server code should import `config` from "@datamate/env/app".
// Browser/client code should import `publicConfig` from "@datamate/env/public".
const URLS = {
	api: {
		cloud: "https://api.datamate.cc",
		local: "http://localhost:3001",
		env: ["API_URL", "NEXT_PUBLIC_API_URL"],
	},
	basket: {
		cloud: "https://basket.datamate.cc",
		local: "http://localhost:4000",
		env: ["BASKET_URL", "NEXT_PUBLIC_BASKET_URL"],
	},
	dashboard: {
		cloud: "https://app.datamate.cc",
	...
	status: {
		cloud: "https://status.datamate.cc",
...
const EMAIL = {
	alertsFrom: {
		default: "Datamate <alerts@datamate.cc>",
		env: ["ALERTS_EMAIL_FROM", "EMAIL_FROM"],
	},
	from: {
		default: "Datamate <no-reply@datamate.cc>",
		env: ["EMAIL_FROM"],
	},
} as const;
