...
describe("versionedName", () => {
	test("inserts version before .js extension", () => {
		expect(versionedName("datamate.js", 1)).toBe("datamate.v1.js");
		expect(versionedName("datamate.js", 42)).toBe("datamate.v42.js");
	});

	test("handles filenames with hyphens", () => {
		expect(versionedName("datamate-debug.js", 3)).toBe(
			"datamate-debug.v3.js"
		);
	});

	test("handles filenames with multiple dots", () => {
		expect(versionedName("datamate.min.js", 5)).toBe("datamate.min.v5.js");
	});
});
