...
import { db, desc, eq, trackerVersions } from "@datamate/db";

const program = new Command();

program
	.name("deploy")
	.description("Deploy Datamate tracker scripts to Bunny.net Storage")
...
const PUBLIC_CDN_URL = "https://datamate.b-cdn.net";
...
async function sendDiscordNotification(
	...
	try {
		...
		const embed = {
			...
			footer: {
				text: "Datamate Tracker Deployment",
			},
		};
