...
const { track, trackError, setGlobalProperties, clear } = useDatamate();
...
<template>
	<div class="page">
		<header class="header">
			<h1>@datamate/nuxt playground</h1>
			<p>
		...
		<main class="main">
			...
			<section class="section">
				...
				<p>
					<code>$datamate</code> is available directly in templates — no
					import needed.
				</p>
				<button
					type="button"
					class="btn"
					@click="$datamate.track('template_click')"
				>
					Track via $datamate
				</button>
			</section>
			...
			<section class="section">
				...
				<a href="https://datamate.cc" target="_blank" rel="noopener">
					datamate.cc ↗
				</a>
			</section>
		</main>
