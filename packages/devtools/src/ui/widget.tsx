...
import { CloseIcon, DatamateMark } from "./icons";
				...
				{state.open ? (
					<>
						<div className="header" ref={headerRef}>
							<div className="header-title">
								<DatamateMark className="brand-mark" />
								<span className="title-text">Datamate</span>
							</div>
					...
					<div className="pill" ref={pillRef}>
						...
						<span className="pill-meta">
							<span className="pill-label">Datamate</span>
