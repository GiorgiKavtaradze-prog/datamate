import XCTest
@testable import Datamate

final class DatamateClientTests: XCTestCase {
    ...
    func testDisabledClientDoesNotSend() async {
        ...
        let client = DatamateClient(
            ...
            transport: URLSessionDatamateTransport(session: session)
        )
    ...
    func testPropertyValuesEncodeJSONTypes() throws {
        let properties: [String: DatamatePropertyValue] = [
            "array": ["one", 2],
            "bool": true,
            "double": 3.5,
            "int": 7,
...
private final class InMemoryStorage: DatamateStorage {
