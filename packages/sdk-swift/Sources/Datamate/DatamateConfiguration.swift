...
public struct DatamateConfiguration: Equatable {
    public static let defaultAPIURL = URL(string: "https://basket.datamate.cc")!
    ...
    public init(
        ...
        self.flushAt = min(
            max(1, flushAt),
            DatamateConfiguration.maximumBatchSize
        )
