...
export const VerificationEmail = ({ url }: VerificationEmailProps) => (
	<EmailLayout
		preview={`Verify your email to start using Datamate. This link expires in ${AUTH_EMAIL_EXPIRY_LABELS.emailVerification}.`}
		tagline="Welcome to Datamate"
	>
...
VerificationEmail.PreviewProps = {
	url: "https://app.datamate.cc/verify/abc123",
