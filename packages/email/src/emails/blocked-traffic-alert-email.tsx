	...
	return (
		<EmailLayout preview={preview} tagline="Tracking alert">
			<Section className="text-center">
				...
				>
					{critical
						? "Datamate is receiving blocked requests for this website while successful pageviews have dropped to zero."
						: "Datamate detected more blocked tracking requests than usual for this website."}
				</Text>
			</Section>
...
BlockedTrafficAlertEmail.PreviewProps = {
	...
	blockReason: "origin_not_authorized",
	blockedCount: 42,
	dashboardUrl: "https://app.datamate.cc/websites/ws_123/settings/general",
