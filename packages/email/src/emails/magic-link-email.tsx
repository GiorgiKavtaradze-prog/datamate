...
export const MagicLinkEmail = ({ url }: MagicLinkEmailProps) => (
	...
	>
		<Section className="text-center">
			...
			>
				Use the button below to sign in to your Datamate account. You do not
				need a password for this sign-in.
			</Text>
		</Section>
		<Section className="text-center">
			<EmailButton href={url}>Sign in to Datamate</EmailButton>
		</Section>
		<EmailNote>
...
MagicLinkEmail.PreviewProps = {
	url: "https://app.datamate.cc/magic/abc123",
