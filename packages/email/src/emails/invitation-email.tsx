...
export const InvitationEmail = ({
	...
	const org = organizationName || "a Datamate organization";
		...
		<EmailLayout preview={`Join ${org} as ${roleLabel}`} tagline="Invitation">
			<Section className="text-center">
				...
				>
					...
					invited you to join {org} on Datamate as {roleWithArticle}.
				</Text>
				<Text
...
InvitationEmail.PreviewProps = {
	invitationLink: "https://app.datamate.cc/invite/abc123",
