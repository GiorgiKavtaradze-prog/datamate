...
export const DQL_TENANT_SETTING = "SQL_datamate_website_id";
...
const DQL_UNPUBLISHED_SQL_PATTERN =
	/\b(?:getClientHTTPHeader|Identifier|information_schema|SQL_datamate_website_id|system)\b/i;
...
const DQL_DEFAULT_CLUSTER = "datamate_cluster";
