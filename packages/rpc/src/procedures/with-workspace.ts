import { hasKeyScope } from "@datamate/api-keys/resolve";
import { requiredScopesForResource } from "@datamate/api-keys/scopes";
import type { User } from "@datamate/auth";
import {
	type PermissionFor,
	type ResourceType,
	roleHasPermission,
} from "@datamate/auth/permissions";
import { db } from "@datamate/db";
import { cacheNamespaces, cacheable } from "@datamate/redis";
import type { PlanId } from "@datamate/shared/types/features";
import { z } from "zod";
