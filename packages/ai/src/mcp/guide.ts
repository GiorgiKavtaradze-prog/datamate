export const GUIDE_URI = "datamate://guide";

export const MCP_INSTRUCTIONS = `Datamate gives agents product analytics and durable investigations.
...
export const GUIDE_MARKDOWN = `# Datamate MCP guide
