...
import { chCommand, chQuery, clickHouse } from "@datamate/db/clickhouse";
		...
		async () => {
			...
			try {
				...
				const identifiedMetadata = {
					datamate_client_id: fixture.siteId,
					datamate_profile_id: profileId,
					datamate_session_id: identifiedSession,
				};
				const profileOnlyMetadata = {
					datamate_client_id: fixture.siteId,
					datamate_profile_id: profileOnlyId,
				};
				const sessionOnlyMetadata = {
					datamate_client_id: fixture.siteId,
					datamate_session_id: sessionOnlyId,
				};
				...
				const events: StripeEvent[] = [
					...
					paymentIntent({
						...
						metadata: {
							...sessionOnlyMetadata,
							datamate_anonymous_id: anonymousId,
						},
					}),
					paymentIntent({
						amount: 2200,
						...
						metadata: { datamate_anonymous_id: saltedAnonymousId },
					}),
					paymentIntent({
						amount: 6000,
						customer: sharedCustomerId,
