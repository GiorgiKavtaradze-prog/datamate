...
async function main() {
	log(chalk.bold("🚀 Datamate Setup Script"));
	...
	const postgresReady = await waitForService("PostgreSQL", "datamate-postgres");
	...
	const redisReady = await waitForService("Redis", "datamate-redis");
