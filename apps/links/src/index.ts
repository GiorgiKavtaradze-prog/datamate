import { db, shutdownPostgres, sql } from "@datamate/db";
import { clickHouse } from "@datamate/db/clickhouse";
import { redis } from "@datamate/redis";
import { buildHttpErrorResponse } from "@datamate/shared/http-error-response";
import {
...
initLogger({
	env: createDatamateEvlogEnv("links"),
...
const rootRedirectUrl =
	process.env.LINKS_ROOT_REDIRECT_URL || "https://datamate.cc";
preloadGeoDatabase();
startLinkVisitDeliveryWorker();
