...
export const homeFaqItems: LandingFaqItem[] = [
	{
		question: "What does the Datamate platform include?",
		answer:
			"Datamate connects analytics, error tracking, web vitals monitoring, feature flags, short links, and AI analysis in one platform. A lightweight browser script collects analytics data; the other capabilities are managed from the same dashboard.",
	},
	{
		question: "How is Datamate different from Google Analytics?",
		answer:
			"Datamate uses a lightweight asynchronous tracker, uses no cookies, and is GDPR compliant by default. It also connects error tracking, Core Web Vitals monitoring, funnels, and feature flags in the same platform.",
	},
	{
		question: "Do I need cookie consent banners?",
		answer:
			"No. Datamate uses no cookies and does not track individual users. You can remove consent banners entirely and remain compliant with GDPR, CCPA, and ePrivacy regulations.",
	},
	{
	...
	},
	{
		...
		answer:
			"Yes. Add Datamate alongside your current tool, compare the data for as long as you need, and remove the old script when you are satisfied with the results.",
	},
	{
	...
	},
	{
		...
		answer:
			"Datamate is open source. You can self-host on your own infrastructure for full data sovereignty, or use our managed cloud where data is encrypted at rest and in transit. We never sell or share your data.",
	},
];
