...
Datamate is a lightweight analytics platform for developers. One asynchronous browser tracker collects analytics, errors, and web vitals; the same platform adds feature flags, short links, and AI analysis.
...
<Cards>
  <Card title="Create Account" href="https://app.datamate.cc">
...
- [Email support](mailto:support@datamate.cc) — direct help from our team
- [GitHub issues](https://github.com/datamate-analytics/datamate/issues) — bug reports and features
