...
<Callout type="info">
  If a production integration needs a different traffic profile, [contact support](mailto:support@datamate.cc) with the endpoint, expected peak rate, and request IDs from any `429` responses.
</Callout>
