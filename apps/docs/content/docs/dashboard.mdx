...
description: Complete guide to using your Datamate analytics dashboard
---
...
Your Datamate dashboard provides comprehensive analytics insights with real-time data, detailed reports, and powerful filtering capabilities.

<Callout type="info">
  **Access**: Visit [app.datamate.cc](https://app.datamate.cc) to view your
  analytics dashboard
</Callout>
...
<Callout type="info">
  **Need Help?** Join our [Discord community](https://discord.gg/JTk7a38tCZ) or
  [contact support](mailto:support@datamate.cc) for dashboard assistance.
</Callout>
