...
Add Datamate's privacy-first analytics to your Wix website to track page views, user interactions, and gather insights about your visitors.

## How to Add Datamate to Wix
...
></script>`}
  ...
  <Step title="Configure the Custom Code">
    ...
    - **Paste your Datamate tracking script** into the main code snippet box
    - **Name your code:** Give it a recognizable name, like "Datamate Analytics"
  ...
  <Step title="Verify Integration">
    After applying the changes, Datamate should start tracking visitors on your Wix site.
...
<Callout type="warn">
  **Important Notes**:
  ...
  - Always check if `window.datamate` exists before calling tracking methods
...
Need help with your Wix integration? Contact us at [support@datamate.cc](mailto:support@datamate.cc).
