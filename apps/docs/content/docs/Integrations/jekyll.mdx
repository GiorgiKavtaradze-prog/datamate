...
Add Datamate's privacy-first analytics to your Jekyll static site by adding the tracking script to your site's main layout file or by creating an include file.

## How to Add Datamate to Jekyll
...
<Steps>
  ...
  <Step title="Add the Tracking Script">
    Open this file and paste the Datamate tracking script just before the closing `</body>` tag.
...
<Steps>
  <Step title="Create the Include File">
    ...
    Create a new file named `datamate-analytics.html` inside `_includes/` and paste the following:

    <CodeBlock
      language="html"
      filename="_includes/datamate-analytics.html"
      code={`{% raw %}{% comment %} Datamate Analytics Include {% endcomment %}
{% if jekyll.environment == "production" and site.datamate_client_id %}
    <script
        src="https://cdn.datamate.cc/datamate.js"
        data-client-id="{{ site.datamate_client_id }}"
        async
    ></script>
{% endif %}{% endraw %}`}
    />
...
<body>
    ...
    {% raw %}{% include datamate-analytics.html %}{% endraw %}
</body>
</html>`}
    />
  </Step>
  ...
  <Step title="Configure _config.yml">
    Open your `_config.yml` file and add your Datamate Client ID:

    <CodeBlock
      language="yaml"
      filename="_config.yml"
      code={`# Datamate Analytics Configuration
datamate_client_id: "YOUR_CLIENT_ID"`}
    />

    This method keeps your credentials in the configuration file and makes the script inclusion conditional on `datamate_client_id` being set.
  </Step>
</Steps>
...
<CodeBlock
  language="html"
  filename="_includes/datamate-analytics.html"
  code={`{% raw %}{% comment %} Datamate Analytics Include with Options {% endcomment %}
{% if jekyll.environment == "production" and site.datamate_client_id %}
    <script
        src="https://cdn.datamate.cc/datamate.js"
        data-client-id="{{ site.datamate_client_id }}"
...
Need help with your Jekyll integration? Contact us at [support@datamate.cc](mailto:support@datamate.cc).
