...
description: Install and configure Datamate for your application
---
...
This guide takes you from a new Datamate account to your first tracked page view.
...
1. Go to [app.datamate.cc](https://app.datamate.cc)
...
Install the official Datamate SDK:
...
Add the `<Datamate />` component once in your root layout:
...
<CodeBlock
  language="bash"
  filename=".env.local"
  code="NEXT_PUBLIC_DATAMATE_CLIENT_ID=your-client-id"
/>
...
2. **Open your Datamate dashboard** at [app.datamate.cc](https://app.datamate.cc)
3. **Check Real-time data** - you should see yourself as an active visitor
4. **Navigate between pages** - Datamate records route changes automatically

<Callout type="success">
  If you see real-time data in your dashboard, congratulations! Datamate is now
...
3. **Check Network tab** - Look for requests to `basket.datamate.cc`
...
<Callout type="info">
  ...
  [contact support](mailto:support@datamate.cc).
</Callout>
