...
The Datamate SDK provides framework-specific components, helper functions, server-side tracking, and a vanilla JavaScript library for tracking analytics events. Choose your preferred integration method.

<Callout type="info">
  **SDK Version**: 2.0.0+ | **Package**: `@datamate/sdk` | **CDN**: cdn.datamate.cc
</Callout>
...
| Import | Description |
|--------|-------------|
| `@datamate/sdk` | Core tracker helpers (track, flush, etc.) |
| `@datamate/sdk/react` | React component and hooks |
| `@datamate/sdk/vue` | Vue component and composables |
| `@datamate/nuxt` | Nuxt module for Datamate tracking |
| `@datamate/sdk/node` | Node.js server-side SDK |
...
<CodeBlock language="tsx">
  {`import { track, type DatamateTracker } from "@datamate/sdk";
import type { DatamateConfig } from "@datamate/sdk/react";
import type { CustomEventInput } from "@datamate/sdk/node";`}
</CodeBlock>
