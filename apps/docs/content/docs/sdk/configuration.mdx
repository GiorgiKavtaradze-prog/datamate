...
description: Complete configuration options for all Datamate SDK platforms
---

import { Callout, CodeBlock, Card, Cards } from "@/components/docs";

This page documents all configuration options across the Datamate SDK platforms: React, Vue, vanilla JavaScript, and Node.js.
...
<Datamate
  ...
  // API endpoints
  apiUrl="https://basket.datamate.cc"
  scriptUrl="https://cdn.datamate.cc/datamate.js"
...
|------|------|---------|-------------|
| `clientId` | `string` | Auto-detect | Client ID (auto-detects from `NEXT_PUBLIC_DATAMATE_CLIENT_ID`) |
| `apiUrl` | `string` | `https://basket.datamate.cc` | API endpoint |
| `scriptUrl` | `string` | `https://cdn.datamate.cc/datamate.js` | Script URL |
...
| `apiUrl` | `string` | `https://api.datamate.cc` | API endpoint |
...
DATAMATE_CLIENT_ID=your-client-id
DATAMATE_API_KEY=your-api-key`}
</CodeBlock>

### Vue / Vite

<CodeBlock language="bash" filename=".env">
  {`VITE_DATAMATE_CLIENT_ID=your-client-id`}
</CodeBlock>
...
<CodeBlock language="bash" filename=".env">
  {`DATAMATE_API_KEY=your-api-key
DATAMATE_WEBSITE_ID=your-client-id  # Optional default Client ID
DATAMATE_API_URL=https://basket.datamate.cc  # Optional`}
</CodeBlock>
