...
The Datamate SDK exports helper functions for tracking events, managing sessions, and cross-domain attribution. These work in any JavaScript environment where the Datamate script is loaded.

<Callout type="info">
  **Import**: `import { track, flush, getAnonymousId, ... } from "@datamate/sdk"`
</Callout>
...
<Callout type="info">
  **Note:** `trackError()` is for *manual* error tracking. To automatically capture all JavaScript errors, use the `trackErrors` prop on the `<Datamate />` component.
</Callout>
...
<CodeBlock language="tsx">
  {`import { clear } from "@datamate/sdk";
...
<CodeBlock language="tsx">
  {`import { track, flush } from "@datamate/sdk";
...
<CodeBlock language="tsx">
  {`import { getAnonymousId } from "@datamate/sdk";
...
<CodeBlock language="tsx">
  {`import { getSessionId } from "@datamate/sdk";
...
Checks if the Datamate tracker script has loaded and is available. Use this before calling tracking functions in conditional scenarios.

<CodeBlock language="tsx">
  {`import { isTrackerAvailable, track } from "@datamate/sdk";
...
Returns the raw Datamate tracker instance for advanced use cases. Prefer using the exported functions instead.

<CodeBlock language="tsx">
  {`import { getTracker } from "@datamate/sdk";
...
<CodeBlock language="tsx">
  {`import { getTrackingParams, getAnonymousId, getSessionId } from "@datamate/sdk";
...
<CodeBlock language="tsx">
  ...
  track, 
  getTracker,
  type DatamateTracker 
} from "@datamate/sdk";

// Tracker instance type
const tracker: DatamateTracker | null = getTracker();`}
</CodeBlock>
