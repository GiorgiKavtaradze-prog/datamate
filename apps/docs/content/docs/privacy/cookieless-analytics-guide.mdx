...
### Option 1: Datamate (Recommended)
Complete cookieless solution with full features:

```html
<!-- Simple implementation -->
<script src="https://cdn.datamate.cc/sdk.js" 
...
window.addEventListener('scroll', () => {
  ...
  if (scrollPercent > maxScroll) {
    ...
    datamate.track('scroll_depth', { percent: scrollPercent });
  }
});
...
window.addEventListener('beforeunload', () => {
  ...
  datamate.track('time_on_page', { duration: timeOnPage });
});
```
...
- **Datamate**: Full-featured, easy migration
...
<script src="https://cdn.datamate.cc/sdk.js" data-client-id="your-id"></script>
...
Ready to go cookieless? Datamate makes the transition simple and seamless.

[Start your cookieless analytics journey →](https://app.datamate.cc/register)
