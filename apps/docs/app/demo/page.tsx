import { ArrowLeftIcon } from "@datamate/ui/icons";
...
export const metadata: Metadata = {
	title: "Live Demo | Datamate",
	description:
		"Experience Datamate analytics in action with our live demo dashboard. See real-time analytics, insights, and privacy-first tracking.",
};
	...
	return (
		<div className="fixed inset-0 h-full w-full">
				...
				<div className="mx-auto flex max-w-7xl flex-col gap-4 px-4 py-4 md:flex-row md:items-center md:justify-between md:px-6">
					<div className="max-w-2xl">
						...
						<p className="mt-2 max-w-xl text-muted-foreground text-sm leading-6 md:text-base">
							...
							Datamate turns the dashboard into answers your team can act on.
						</p>
					</div>
			...
			<iframe
				...
				title="Datamate Analytics Demo Dashboard"
			/>
		</div>
	);
}
