...
const title = "Terms of Service - Usage Policies & Legal Agreement | Datamate";
const url = "https://www.datamate.cc/terms";

export const metadata: Metadata = {
	title,
	description:
		"Clear and fair terms that govern your use of Datamate's analytics platform. We believe in transparency and straightforward language.",
	alternates: {
		canonical: url,
	},
	openGraph: {
			...
			<div className="mx-auto w-full max-w-7xl px-4 pt-16 sm:px-6 lg:px-8 lg:pt-24">
				...
				<div className="mb-12 text-center">
					...
					<p className="mx-auto max-w-2xl text-muted-foreground">
						Clear and fair terms that govern your use of Datamate’s analytics
				...
				<div className="prose prose-lg dark:prose-invert max-w-none">
					<p className="lead mb-8 text-lg text-muted-foreground">
						...
						Datamate's analytics platform ("Service"). By using our Service, you
					...
					<section className="mb-8">
						...
						<p className="mb-4">
							Welcome to Datamate ("we," "our," or "us"). These Terms of Service
							govern your access to and use of our privacy-first analytics
							platform available at https://app.datamate.cc and our related
							services.
						</p>
						<p className="mb-4">
					...
					<section className="mb-8">
						...
						<ul className="mb-4 space-y-3">
							...
							<li>
								<strong>Service:</strong> Datamate's analytics platform and
								related services
							</li>
							<li>
							...
							<li>
								<strong>Website:</strong> The Datamate website at
					...
					<section className="mb-8">
						...
						<p className="mb-4">
							...
							are owned by Datamate and are protected by copyright, trademark,
							and other laws.
						</p>
						<ul className="mb-4 space-y-2">
					...
					<section className="mb-8">
						...
						<p className="mb-4">
							To the maximum extent permitted by law, Datamate shall not be
					...
					<section className="mb-8">
						...
						<p className="mb-4">
							...
							laws of the jurisdiction where Datamate is incorporated, without
					...
					<section className="mb-8">
						...
						<div className="rounded bg-accent p-4">
							<ul className="mb-0 space-y-2">
								<li>
									<strong>Email:</strong> legal@datamate.cc
								</li>
								<li>
									<strong>Support:</strong> support@datamate.cc
								</li>
								<li>
									<strong>Website:</strong> www.datamate.cc/contact
								</li>
							</ul>
						</div>
					</section>
					...
					<section className="mb-8">
						...
						<p className="mb-4">
							...
							, constitute the entire agreement between you and Datamate
