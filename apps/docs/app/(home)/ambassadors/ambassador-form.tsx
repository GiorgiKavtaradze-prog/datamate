...
import { CheckIcon, PaperPlaneIcon, SpinnerIcon } from "@datamate/ui/icons";
			...
			<div className="mx-auto max-w-md text-center">
				...
				>
					...
					<p className="text-muted-foreground text-sm">
						Thank you for your interest in becoming a Datamate ambassador. We'll
		...
		<div>
			<div className="mb-8 text-center">
				...
				<p className="mx-auto max-w-2xl text-muted-foreground text-sm sm:text-base lg:text-lg">
					Tell us about yourself and why you'd be a great Datamate ambassador
				</p>
			</div>
			...
			<SciFiCard className="relative rounded border border-border bg-card/50 p-6 backdrop-blur-sm sm:p-8">
				<form className="space-y-6" onSubmit={handleSubmit}>
					...
					<FormField
						...
						label="Why do you want to be a Datamate ambassador?"
						required
					>
						<Textarea
					...
					<FormField label="How did you hear about Datamate?">
						<Input
							maxLength={200}
							name="referralSource"
							onChange={handleInputChange}
