...
const title = "Datamate Developer Resources - API Docs, OpenAPI, MCP & SDKs";
const description =
	"Find Datamate developer resources for agents and humans: API docs, OpenAPI spec, authentication, webhooks, MCP server, SDKs, and llms.txt.";
				...
				<div className="mx-auto w-full max-w-6xl">
					<div className="max-w-3xl">
						...
						<p className="mt-5 text-lg text-muted-foreground">
							...
							SDK guides, and LLM-readable documentation for Datamate.
						</p>
					</div>
