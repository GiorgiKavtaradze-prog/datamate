...
function AgentModeView() {
	...
	return (
		<main className="mx-auto w-full max-w-5xl px-4 pt-24 pb-16 sm:px-6 lg:px-8">
			<h1 className="font-semibold text-4xl">Datamate Agent View</h1>
			<p className="mt-4 text-lg text-muted-foreground">
				Structured entrypoint for AI agents integrating Datamate analytics,
			...
			<section className="mt-10" id="agent-auth">
				...
				<p className="mt-4 text-muted-foreground">
					Send a scoped Datamate API key in <code>x-api-key</code> or{" "}
