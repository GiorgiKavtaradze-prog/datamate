...
export function AiPricingSummary({ plans }: { plans: RawPlan[] }) {
	...
	const full = [
		...
		"Machine-readable version: https://www.datamate.cc/api/pricing",
		"",
		summary,
		"",
		"Sign up: https://app.datamate.cc/register",
	].join("\n");

	return (
		<section
			aria-label="Datamate pricing summary for AI agents and screen readers"
			className="sr-only"
			data-ai-pricing
		>
			<pre>{full}</pre>
