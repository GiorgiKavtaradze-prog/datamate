		...
		<div className="mx-auto w-full max-w-6xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
			...
			<div className="mb-16 max-w-3xl sm:mb-24">
				...
				<h1 className="mb-4 text-balance font-semibold text-3xl text-foreground sm:text-4xl lg:text-5xl">
					Datamate brand assets
				</h1>
				<p className="text-pretty text-base text-muted-foreground sm:text-lg">
					Everything you need to represent Datamate. Use these assets
			...
			<section className="mb-16 sm:mb-24" id="gradients">
				...
				<div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
					<div className="overflow-hidden rounded border border-border">
						<img
							alt="Datamate gradient background 1"
					...
					<div className="overflow-hidden rounded border border-border">
						<img
							alt="Datamate gradient background 2"
							className="aspect-video w-full object-cover"
							height={360}
			...
			<section className="mb-16 sm:mb-24" id="typography">
				<SectionHeader
					description="Two typefaces form the Datamate type system - LT Superior for display and body, and LT Superior Mono for code and technical content."
					title="Typography"
				/>
					...
					<div className="space-y-4">
						...
						<div className="flex flex-col gap-1 sm:flex-row sm:items-baseline sm:gap-6">
							...
							<span className="text-foreground text-sm sm:text-base">
								Your Datamate dashboard provides comprehensive analytics
			...
			<section id="dos-and-donts">
				<SectionHeader
					description="Follow these rules to keep Datamate's brand consistent and recognizable."
					title="Usage rules"
				/>
