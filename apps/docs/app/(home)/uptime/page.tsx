...
export const metadata: Metadata = {
	...
	description:
		"1-minute checks from six regions, instant alerts, and public status pages - included with Datamate. Launching Q3 2026. Join the waitlist for early access.",
	alternates: {
		canonical: "https://www.datamate.cc/uptime",
	},
	openGraph: {
		title: "Uptime Monitoring (coming Q3 2026)",
		description:
			"1-minute checks from six regions, instant alerts, and public status pages - included with Datamate. Launching Q3 2026.",
		url: "https://www.datamate.cc/uptime",
		images: ["/og-image.png"],
	},
};
		...
		<>
			...
			<StructuredData
				...
				page={{
					...
					description:
						"1-minute checks, status pages, and instant alerts - coming to Datamate Q3 2026.",
					url: "https://www.datamate.cc/uptime",
				}}
			/>
