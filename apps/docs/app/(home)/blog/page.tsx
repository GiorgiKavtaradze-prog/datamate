import { CalendarIcon, ClockIcon, TagIcon, UserIcon } from "@datamate/ui/icons";
...
const blogDescription =
	"Practical articles on instrumentation, GDPR compliance, Core Web Vitals, and developer-first analytics from the Datamate team.";
const blogUrl = "https://www.datamate.cc/blog";
					...
					<div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
						...
						<div className="mb-8 text-center lg:mb-10">
							...
							<p className="mx-auto max-w-2xl text-balance font-medium text-muted-foreground text-xs leading-relaxed tracking-tight sm:text-sm lg:text-base">
								...
								developer‑first analytics from the Datamate team.
							</p>
						</div>
					</div>
				</section>
