...
export const metadata: Metadata = {
	...
	alternates: {
		canonical: "https://www.datamate.cc/web-vitals",
	},
	openGraph: {
		title: "Core Web Vitals Monitoring - Real User Performance Analytics",
		description:
			"Monitor LCP, CLS, INP, FCP, and TTFB from real users in production. Percentile breakdowns by page, device, and country. Field data, not lab simulations. Built into your analytics.",
		url: "https://www.datamate.cc/web-vitals",
		images: ["/og-image.png"],
	},
};
...
const FAQ_ITEMS = [
	{
		...
		answer:
			"Lab data (like Lighthouse) runs in a controlled environment. Field data - what Datamate collects - comes from real users on real devices and connections. Google uses field data for rankings, so field data is what matters.",
	},
	{
		question: "Which percentile does Google use to score my site?",
		answer:
			"Google scores your site at the 75th percentile, meaning 75% of your users need to have a Good experience. Datamate shows p75 prominently so you always know where you stand.",
	},
	{
		question: "How does Datamate measure INP?",
		answer:
