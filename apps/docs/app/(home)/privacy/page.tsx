...
const title = "Privacy Policy - Cookie-less, GDPR by default | Datamate";
const description =
	"Datamate's comprehensive privacy policy for our privacy-first analytics service. Learn how we protect both customer and end user data with GDPR compliance and no user identification.";
const url = "https://www.datamate.cc/privacy";
		...
		<>
			...
			<div className="mx-auto w-full max-w-7xl px-4 pt-16 sm:px-6 lg:px-8 lg:pt-24">
				...
				<div className="mb-8 rounded border border-accent bg-accent/50 p-6">
					...
					<p className="mb-4 text-muted-foreground">
						Datamate provides website analytics without compromising user
				...
				<div className="prose prose-lg dark:prose-invert max-w-none">
					<p className="lead mb-8 text-lg text-muted-foreground">
						Datamate ("we", "our", or "us") is a privacy-first analytics service
						that provides website insights without compromising user privacy.
						This Privacy Policy describes how we collect, use, and protect
						information when you use our service or visit websites that use our
						analytics.
					</p>
					...
					<section className="mb-8">
						...
						<ul className="mb-4 space-y-2">
							<li>
								...
								sign up for and use Datamate's analytics services for their
								websites.
							</li>
							<li>
								<strong>End Users:</strong> Visitors to websites that use
								Datamate analytics. If you're visiting a website that uses our
					...
					<section className="mb-8">
						...
						<p className="mb-4">
							Datamate is built on privacy-first principles that guide
							everything we do:
						</p>
					...
					<section className="mb-8">
						...
						<p className="mb-3">When you sign up for Datamate, we collect:</p>
						...
						<p className="mb-3">
							When someone visits a website using Datamate analytics, we collect
					...
					<section className="mb-8">
						...
						<p className="mb-4">
							Unlike traditional analytics services, Datamate is designed to
						...
						<p>
							This means end users visiting websites with Datamate analytics
						...
						<div className="mt-4 mb-6 rounded border bg-muted/50 p-5">
							<p className="mb-3 flex items-center text-primary">
								...
								<a
									...
									href="mailto:privacy@datamate.cc"
								>
									privacy@datamate.cc
								</a>
							</p>
