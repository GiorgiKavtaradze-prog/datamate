			...
			<div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
				...
				<div className="mb-12 text-center lg:mb-16">
					<h1 className="mb-4 font-semibold text-3xl leading-tight tracking-tight sm:text-5xl md:text-6xl lg:text-7xl xl:text-[72px]">
						...
						<span className="block">
							behind <span className="text-muted-foreground">Datamate</span>
						</span>
					</h1>
				...
				<div className="grid grid-cols-2 gap-4 sm:gap-6 lg:grid-cols-4 lg:gap-8">
					<StatCard
						...
						href="https://github.com/datamate-analytics/Datamate/stargazers"
						icon={StarIcon}
						label="Stars"
						value={stars}
					/>
					<StatCard
						...
						href="https://github.com/datamate-analytics/Datamate/forks"
						icon={GitForkIcon}
						label="Forks"
						value={forks}
					/>
					<StatCard
						...
						href="https://github.com/datamate-analytics/Datamate/issues?q=is%3Aissue+is%3Aopen"
					...
					<StatCard
						...
						href="https://github.com/datamate-analytics/Datamate/graphs/contributors"
						icon={UsersIcon}
						label="Contributors"
						value={contributors}
					/>
