...
export const careerOpenings: CareerOpening[] = [
	{
		...
		applyHref:
			"mailto:support@datamate.cc?subject=Founding%20Engineer%20Application%20%E2%80%94%20Datamate",
	...
	},
	{
		...
		location: "Remote",
		summary:
			"Own outbound and inbound qualification for Datamate. You'll find teams that care about privacy-first analytics, start the conversation, and book qualified demos for the founders.",
		responsibilities: [
		...
		applyHref:
			"mailto:support@datamate.cc?subject=SDR%20Application%20%E2%80%94%20Datamate",
