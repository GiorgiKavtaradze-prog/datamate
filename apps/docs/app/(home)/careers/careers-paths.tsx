...
const paths: Path[] = [
	{
		...
		cta: {
			label: "Open issues",
			href: "https://github.com/datamate-analytics/Datamate/issues",
			external: true,
		},
		highlight: true,
	},
	{
		...
		description:
			"If you're already using Datamate and want to help grow it, the ambassador program comes with early access, a private channel, and a direct line to the team.",
	...
	},
	{
		...
		cta: { label: "support@datamate.cc", href: "mailto:support@datamate.cc" },
	},
];
