import { ArrowRightIcon } from "@datamate/ui/icons";
...
const compareTitle =
	"Datamate vs Other Analytics Platforms - Feature Comparisons";
const compareDescription =
	"Side-by-side comparisons of Datamate against Google Analytics, Plausible, Fathom, and more. See which privacy-first analytics platform fits your stack.";
const compareUrl = "https://www.datamate.cc/compare";
				...
				<div className="mx-auto w-full max-w-5xl px-4 sm:px-6 lg:px-8">
					<div className="text-center">
						...
						<p className="mx-auto max-w-2xl text-balance text-muted-foreground text-sm leading-relaxed sm:text-base">
							See how Datamate stacks up against other analytics platforms.
				...
				<div className="mx-auto w-full max-w-5xl px-4 sm:px-6 lg:px-8">
					...
					<div className="mt-12 rounded border border-border bg-card/30 p-6 text-center backdrop-blur-sm sm:p-8">
						...
						<p className="mb-5 text-pretty text-muted-foreground text-sm">
							We're adding new comparisons regularly. Try Datamate today and see
							the difference.
						</p>
						<div className="flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
							<SciFiButton asChild>
								<Link
									href="https://app.datamate.cc/register"
