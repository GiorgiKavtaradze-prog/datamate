...
export const metadata: Metadata = {
	...
	alternates: {
		canonical: "https://www.datamate.cc/roadmap",
	},
	openGraph: {
		title: "Roadmap | Datamate",
		description:
			"Discover what we're building next. Our transparent roadmap shows upcoming features, current progress, and completed milestones.",
		url: "https://www.datamate.cc/roadmap",
		images: ["/og-image.png"],
	},
};
...
export default function RoadmapPage() {
	...
	const title = "Roadmap | Datamate";
	const description =
		"Discover what we're building next. Our transparent roadmap shows upcoming features, current progress, and completed milestones.";
	const url = "https://www.datamate.cc/roadmap";
				...
				<div className="mx-auto w-full max-w-4xl px-4 text-center sm:px-6 lg:px-8">
					...
					<div className="mt-8 flex flex-col gap-4 sm:flex-row sm:justify-center">
						<a
							...
							href="https://github.com/datamate-analytics/Datamate/discussions"
							rel="noopener"
							target="_blank"
						>
							Join Discussion
						...
						<a
							...
							href="https://github.com/datamate-analytics/Datamate/issues/new?template=feature_request.md"
							rel="noopener"
							target="_blank"
						>
							Request Feature
