...
export const metadata: Metadata = {
	title: "Contact Us | Datamate",
	description:
		"Get in touch with the Datamate team. We'd love to hear from you.",
	alternates: {
		canonical: "https://www.datamate.cc/contact",
	},
	openGraph: {
		title: "Contact Us | Datamate",
		description:
			"Get in touch with the Datamate team. We'd love to hear from you.",
		url: "https://www.datamate.cc/contact",
		images: ["/og-image.png"],
	},
};

export default function ContactPage() {
	const title = "Contact Us | Datamate";
	const description =
		"Get in touch with the Datamate team. We'd love to hear from you.";
	const url = "https://www.datamate.cc/contact";
