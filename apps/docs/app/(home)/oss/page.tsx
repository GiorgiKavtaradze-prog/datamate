...
export const metadata: Metadata = {
	title: "Datamate for open source",
	description:
		"One year of Datamate Pro, free, for maintainers of active open source projects.",
	alternates: {
		canonical: "https://www.datamate.cc/oss",
	},
	openGraph: {
		title: "Datamate for open source",
		description:
			"One year of Datamate Pro, free, for maintainers of active open source projects.",
		url: "https://www.datamate.cc/oss",
		images: ["/og-image.png"],
	},
};

export default function OssPage() {
	const title = "Datamate for open source";
	const description =
		"One year of Datamate Pro, free, for maintainers of active open source projects.";
	const url = "https://www.datamate.cc/oss";
			...
			<Section className="overflow-hidden" id="oss">
				<div className="mx-auto w-full max-w-xl px-4 pt-20 pb-16 sm:px-6 sm:pt-24 sm:pb-20">
					...
					<p className="mb-2 text-pretty text-muted-foreground leading-relaxed">
						One year of Datamate Pro, free, for maintainers of active open
						source projects.
					</p>
