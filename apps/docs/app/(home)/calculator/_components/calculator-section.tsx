		...
		<section className="mx-auto w-full max-w-5xl" id="calculator">
				...
				<div className="lg:col-span-2">
					<SciFiCard>
						<div className="flex h-full flex-col rounded border border-border bg-card/70 p-5 backdrop-blur-sm sm:p-6">
							...
							<div className="flex flex-1 flex-col justify-between gap-4">
								...
								<div className="space-y-2 rounded border border-border bg-card/40 p-3">
									...
									<div className="flex flex-col gap-1.5 text-sm">
										...
										<div className="flex justify-between gap-2">
											<span className="text-muted-foreground">
												Datamate ({results.datamatePlanName})
											</span>
											<span className="font-semibold tabular-nums">
												{formatCurrencyFull(results.datamateMonthlyCost)}
												/mo
											</span>
										</div>
									</div>
							...
							<ShareButtons
								datamateMonthlyCost={results.datamateMonthlyCost}
			...
			<div className="mt-4 text-center">
				<p className="text-pretty text-muted-foreground text-xs">
					...
					Sources below. Datamate needs no consent cookie; any JS can still be
					blocked.
				</p>
			</div>
		</section>
