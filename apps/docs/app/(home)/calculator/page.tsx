...
/** Matches defaults: 50k visitors, 55% data loss, 1.5% visitor-to-paid, $50 - ~$248k/yr; ~$11/mo Datamate at this volume */
...
export async function generateMetadata({
	...
	const personalizedDescription = hasPersonalizedParams
		? `Modeled unattributed revenue ~$${Number(revenue).toLocaleString()}/year (measurement gap) vs Datamate ~$${Number(cost).toLocaleString()}/month - not literal loss.`
		: DESCRIPTION;
