...
export const metadata: Metadata = {
	title: "Sponsors | Datamate",
	description:
		"Support Datamate and help us build the future of privacy-first analytics",
	alternates: {
		canonical: "https://www.datamate.cc/sponsors",
	},
	openGraph: {
		title: "Sponsors | Datamate",
		description:
			"Support Datamate and help us build the future of privacy-first analytics",
		url: "https://www.datamate.cc/sponsors",
		images: ["/og-image.png"],
	},
};

export default function SponsorsPage() {
	const title = "Sponsors | Datamate";
	const description =
		"Support Datamate and help us build the future of privacy-first analytics";
	const url = "https://www.datamate.cc/sponsors";
				...
				<div className="mx-auto w-full max-w-4xl px-4 text-center sm:px-6 lg:px-8">
					...
					<div className="flex flex-col gap-4 sm:flex-row sm:justify-center">
						<a
							...
							href="mailto:sponsors@datamate.cc?subject=Sponsorship%20Inquiry"
						>
							Become a Sponsor
						</a>
						<a
							...
							href="mailto:sponsors@datamate.cc?subject=Sponsorship%20Questions"
						>
							Ask Questions
						</a>
					</div>
