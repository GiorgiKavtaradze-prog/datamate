...
export const metadata: Metadata = {
	...
	alternates: {
		canonical: "https://www.datamate.cc/feature-flags",
	},
	openGraph: {
		title: "Feature Flags & A/B Testing - Built Into Your Analytics",
		description:
			"Ship features safely with instant rollouts, percentage-based releases, A/B testing, and user targeting. No deploys needed. Built into your analytics dashboard.",
		url: "https://www.datamate.cc/feature-flags",
		images: ["/og-image.png"],
	},
};
		...
		<>
			...
			<div className="overflow-x-hidden">
				<FeatureHero
					...
					subtitle="Boolean toggles, percentage rollouts, and A/B experiments - controlled from your dashboard, no deploys needed. Built into Datamate."
