...
export const metadata: Metadata = {
	...
	alternates: {
		canonical: "https://www.datamate.cc/links",
	},
	openGraph: {
		title: "Short Links & Click Analytics",
		description:
			"Create branded short links with built-in click analytics, UTM tagging, QR codes, deep linking, and referrer tracking. Every click tracked inside your analytics dashboard.",
		url: "https://www.datamate.cc/links",
		images: ["/og-image.png"],
	},
};
...
const FAQ_ITEMS = [
	{
		...
		answer:
			"Yes. You can connect any custom domain and use it as your link base. All analytics still flow into your Datamate dashboard.",
	},
	{
		question: "How is this different from Bitly or Dub?",
		answer:
			"Datamate links live inside your analytics stack. Every click is connected to the same dashboard where you track pageviews, errors, and conversions. No separate tool, no data silos.",
	},
	{
