...
const switchFromTitle =
	"Switch from Plausible, Fathom, Google Analytics & More | Datamate";
const switchFromDescription =
	"Migration-focused comparison pages: what you keep, what you gain, and how pricing compares when you switch from major analytics tools to Datamate.";
					...
					<div className="mx-auto w-full max-w-5xl px-4 sm:px-6 lg:px-8">
						<div className="text-center">
							...
							<p className="mx-auto max-w-2xl text-balance text-muted-foreground text-sm leading-relaxed sm:text-base">
								...
								you move to Datamate. You can also browse{" "}
								<Link
