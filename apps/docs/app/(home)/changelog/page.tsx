import { RocketLaunchIcon } from "@datamate/ui/icons";
...
export const metadata: Metadata = {
	title: "Changelog | Datamate",
	description:
		"Stay up to date with the latest features, improvements, and fixes shipped to Datamate.",
	alternates: {
		canonical: "https://www.datamate.cc/changelog",
	},
	openGraph: {
		title: "Changelog | Datamate",
		description:
			"Stay up to date with the latest features, improvements, and fixes shipped to Datamate.",
		url: "https://www.datamate.cc/changelog",
		images: ["/og-image.png"],
	},
	twitter: {
					...
					<div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
						<div className="mb-8 text-center lg:mb-10">
							...
							<p className="mx-auto max-w-2xl text-balance font-medium text-muted-foreground text-xs leading-relaxed tracking-tight sm:text-sm lg:text-base">
								...
								Datamate, straight from the team.
							</p>
						</div>
					</div>
				</section>
