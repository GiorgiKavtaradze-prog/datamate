...
export const manifestoIntro = {
	title: "The Datamate Manifesto",
	lead: [
		"I built Datamate because I was tired of pretending the analytics industry wasn't broken. Every tool I used was either spying on my users, drowning me in dashboards I'd never read, or charging me enterprise prices to answer questions a five-year-old could phrase better.",
...
export const manifestoSections: readonly ManifestoChapter[] = [
	...
	},
	{
		...
		blocks: [
			...
			{
				type: "paragraph",
				text: "Datamate\u2019s tracking script is 30KB. No cookies. No fingerprints. No personal identifiers. No consent banners scaring away 30\u201340% of your visitors before they even see your product. You install it, and it works. Your users never know it\u2019s there, because it never asks them for anything.",
			},
			{
				type: "paragraph",
	...
	},
	{
		...
		blocks: [
			...
			{
				type: "paragraph",
				text: "Databunny, the AI agent inside Datamate, answers questions, builds charts, and runs investigations. When you configure a schedule and Slack delivery, it sends actionable investigations to your chosen channels.",
			},
			{
				type: "paragraph",
	...
	},
	{
		...
		blocks: [
			{
				type: "paragraph",
				text: "Datamate is for the founder who checks analytics between deploys. The engineer who wants to know if the feature they shipped last night actually moved a number. The two-person team that doesn\u2019t have a \u201Cdata person\u201D and shouldn\u2019t need one.",
			},
			{
				type: "paragraph",
			...
			{
				type: "paragraph",
				text: "That\u2019s it. That\u2019s Datamate.",
			},
		],
	},
] as const;
