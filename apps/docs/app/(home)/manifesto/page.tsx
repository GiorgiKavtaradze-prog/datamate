...
const title = "The Datamate Manifesto | Datamate";
const description =
	"Why we built Datamate: analytics that respects users, connects context, and answers in plain language - without enterprise bloat or cookie theater.";
const url = "https://www.datamate.cc/manifesto";
