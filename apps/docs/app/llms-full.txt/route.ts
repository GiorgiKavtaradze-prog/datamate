...
const HEADER = `# Datamate Documentation (Full)
...
export async function GET() {
	...
	if (body.length > MAX_LLMS_FULL_CHARS) {
		const notice =
			"\n\n---\n\n## Additional Documentation\n\nThis single-file agent corpus is capped below 200,000 characters for one-request ingestion. Continue with the scoped indexes at https://www.datamate.cc/docs/llms.txt, https://www.datamate.cc/api/llms.txt, and https://www.datamate.cc/developers/llms.txt.\n";
