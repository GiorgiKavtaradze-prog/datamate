...
import { XMarkIcon as XLogoIcon } from "@datamate/ui/icons";
...
const testimonials = [
	...
	},
	{
		...
		description:
			"Actually game changing going from Framer analytics to @trydatamate. We're such happy customers.",
	...
	},
	{
		...
		description: "won't lie @trydatamate is very easy to setup damn",
	...
	},
	{
		...
		description:
			"if you're not using @trydatamate then your analytics are going down the drain.",
		avatar: "ahmet.jpg",
	},
	{
		name: "Maze",
		...
		social: null,
		description: "@trydatamate is the only analytics i love.",
		avatar: "maze.jpg",
	},
	{
		name: "Yassr Atti",
		profession: "Founder, Call",
		description: "everything you need for analytics is at @trydatamate 🔥",
	...
	},
	{
		...
		social: null,
		description:
			"Datamate is the only analytics platform I've used that I can genuinely say is actually GDPR compliant, and an absolute beast of a product.  Worth a try!",
		avatar: "ping.jpg",
	},
	{
		name: "Fynn",
		...
		description:
			"it's actually such a upgrade to switch from posthog to @trydatamate",
			...
			<div className="mb-10 flex items-start gap-2 px-4 text-start sm:mb-12 sm:px-6 md:px-0 lg:mb-16">
				...
				<div>
					...
					<p className="max-w-2xl text-muted-foreground text-sm sm:text-base lg:text-xl">
						Hear from developers using Datamate alongside or instead of GA4,
