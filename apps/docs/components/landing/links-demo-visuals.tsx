...
const DEEP_LINKS = [
	{
		app: "Instagram",
		color: "#E4405F",
		url: "instagram.com/datamate",
		resolved: "instagram://user?username=datamate",
	...
	},
	{
		app: "X",
		color: "#fff",
		url: "x.com/trydatamate",
		resolved: "twitter://user?screen_name=trydatamate",
	...
	return (
		<div className="space-y-3">
			...
			<p className="text-muted-foreground text-xs">
				Paste any link from a supported app. Datamate resolves it to a native
