import { ArrowRightIcon, CheckIcon } from "@datamate/ui/icons";
...
export function CompetitorCard({
	...
	const advantages = features.filter((f) => f.datamate && !f.competitor);
		...
		>
			...
			<div className="mb-5 flex items-center justify-between border-border/50 border-b pb-4 text-sm">
				...
				<div className="flex flex-col items-end">
					<span className="text-muted-foreground text-xs">Datamate</span>
