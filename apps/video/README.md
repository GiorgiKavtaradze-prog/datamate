# Datamate product video

This workspace renders a 16-second, 16:9 Datamate Intelligence release video.
...
1. **Arrival** — meet Datamate Intelligence with a bouncing signal / bunny
   motif.
...
7. **Promise + close** — land the product promise, the brand, and `datamate.cc`.

## Source assets

All source visuals are copied from the existing Datamate brand library into
