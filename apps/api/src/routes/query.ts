...
import { and, db, eq, inArray } from "@datamate/db";
import { profiles } from "@datamate/db/schema";
...
import {
	...
	type TraitFilter,
	TraitFilterError,
} from "@datamate/services/identity";
import { validateTimezone } from "@datamate/validation";
import { readBooleanEnv } from "@datamate/env/boolean";
import { getRateLimitHeaders, ratelimit } from "@datamate/redis/rate-limit";
import { getBillingOwner } from "@datamate/rpc/billing";
import { getOrganizationOwnerId } from "@datamate/rpc/organization";
import {
	type GatedFeatureId,
	GATED_FEATURES,
	isFeatureAvailable,
} from "@datamate/shared/types/features";
import {
	allowedFilterFields,
	compileQuery,
	executeBatch,
	isFilterFieldAllowed,
} from "@datamate/ai/query";
import {
	canReadQueryTypesPublicly,
	QueryBuilders,
} from "@datamate/ai/query/builders";
import {
	isNormalizedQueryDate,
	normalizeClickHouseDateTime,
} from "@datamate/ai/query/date-utils";
import type { Filter, QueryRequest } from "@datamate/ai/query/types";
import { Elysia, t } from "elysia";
import { getAccessibleWebsites } from "@datamate/ai/lib/accessible-websites";
import {
	getCachedWebsiteDomain,
	getWebsiteDomain,
} from "@datamate/ai/lib/website-utils";
import { resolveDatePreset } from "@datamate/ai/lib/date-presets";
...
async function enforceQueryRateLimit(
	...
	if (readBooleanEnv("DATAMATE_E2E_MODE")) {
		return null;
	}
