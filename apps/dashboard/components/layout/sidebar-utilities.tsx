...
import { Skeleton, Tooltip, useHydrated } from "@datamate/ui";
import { Avatar, DropdownMenu } from "@datamate/ui/client";
import {
	BugIcon,
	CalendarIcon,
	EnvelopeIcon,
	...
	return (
		<DropdownMenu>
			...
			>
				...
				<DropdownMenu.Item
					onClick={() => window.open("mailto:support@datamate.cc", "_self")}
				>
				...
				<DropdownMenu.Item
					onClick={() =>
						window.open(
							"https://github.com/datamate-analytics/Datamate/issues",
							"_blank"
						)
					}
				>
