...
import { Button, Text } from "@datamate/ui";
import { Dialog } from "@datamate/ui/client";
...
const HELP_ITEMS = [
	...
	{
		href: "https://www.youtube.com/@trydatamate",
		icon: PlayIcon,
		title: "Tutorials",
		description: "Learn Datamate step by step",
		external: true,
	},
] as const;
		...
		>
			<Dialog.Content>
				<Dialog.Header>
					...
					<Dialog.Description>
						Get assistance and learn more about Datamate
					</Dialog.Description>
				</Dialog.Header>
