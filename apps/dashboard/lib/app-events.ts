...
import type {
	...
	SignupMethod,
} from "@datamate/shared/custom-events";
import {
...
const ONBOARDING_ATTRIBUTION_KEY = "datamate.onboardingAttribution";
const PENDING_SOCIAL_SIGNUP_KEY = "datamate.pendingSocialSignup";
