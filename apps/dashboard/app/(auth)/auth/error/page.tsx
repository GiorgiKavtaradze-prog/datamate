...
import { ArrowLeftIcon, ShieldWarningIcon } from "@datamate/ui/icons";
	...
	return (
		<>
			...
			<div className="mt-5 flex flex-wrap items-center justify-center gap-4 px-6">
				...
				<div className="text-[13px] text-accent-foreground/60 duration-200 hover:text-accent-foreground">
