...
import { ArrowLeftIcon, EnvelopeSimpleIcon } from "@datamate/ui/icons";
import { Button, Field, Input, Spinner, Text } from "@datamate/ui";
	...
	const handleMagicLinkLogin = async (e: React.FormEvent) => {
		...
		try {
			...
			if (error) {
				...
				sessionStorage.setItem("datamate:magic-email", email);
				router.push(
