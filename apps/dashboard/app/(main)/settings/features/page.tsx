...
import { RocketIcon } from "@datamate/ui/icons";
	...
	return (
		<div className="h-full lg:grid lg:grid-cols-[1fr_18rem]">
			...
			<RightSidebar className="gap-0 p-0">
				...
				<RightSidebar.Section>
					<RightSidebar.Tip description="Soon you'll be able to opt into early access features and help shape the future of Datamate." />
				</RightSidebar.Section>
			</RightSidebar>
		</div>
	);
