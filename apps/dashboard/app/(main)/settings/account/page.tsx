...
import { Avatar, Dialog } from "@datamate/ui/client";
import {
	Badge,
	Button,
	Card,
		...
		<Dialog onOpenChange={(open) => !open && onClose()} open={!!account}>
			<Dialog.Content>
				<Dialog.Header>
					...
					<Dialog.Description>
						This removes {providerName} as a way to sign in to Datamate. It does
						not disconnect an organization data integration. You can reconnect
						this identity later.
					</Dialog.Description>
				</Dialog.Header>
				{account && (
				...
				<div className="mx-auto max-w-2xl space-y-6 p-5">
					...
					<Card>
						<Card.Header>
							...
							<Card.Description>
								Personal sign-in methods for your Datamate account. These are
