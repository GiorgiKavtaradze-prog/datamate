...
import type { SlackIntegrationOutput } from "@datamate/rpc";
...
import { Accordion, Autocomplete, DeleteDialog } from "@datamate/ui/client";
...
const SLACK_ITEM: IntegrationCatalogItem = {
	accent: "#611f69",
	category: "AI agent",
	description: "Ask Datamate analytics questions from Slack channels and DMs.",
...
const COMING_SOON_INTEGRATIONS: IntegrationCatalogItem[] = [
	...
	},
	{
		accent: "#E37400",
		category: "Import",
		description: "Import historical traffic when teams migrate into Datamate.",
		...
		<div className="flex h-full flex-col">
				...
				<div className="mx-auto max-w-4xl p-5">
					<Card>
						<Card.Header>
							...
							<Card.Description>
								Connect Datamate to the tools your organization already uses
							</Card.Description>
						</Card.Header>
			...
			{pendingUninstall && (
				<DeleteDialog
					...
					description={`${pendingUninstall.teamName ?? pendingUninstall.teamId} will be disconnected from Datamate. Channel bindings will be removed and the Slack agent API key will be revoked.`}
	...
	return (
		<div className="rounded border border-border/60 bg-secondary/30">
			<div className="border-border/60 border-b px-3 py-2">
				<Text tone="muted" variant="caption">
					Link a GitHub repository to each website so Datamate can correlate
		...
		<div className="border-border/60 border-b px-3 py-3 last:border-b-0">
			...
			<div className="mt-3 rounded border border-border/60 bg-background px-3 py-2">
				<Text tone="muted" variant="caption">
					...
					websites itself when an analytics question needs one. Mention Datamate
					in an internal channel and it will connect that channel automatically.
					Use <SlackCommand value="/bind" /> for Slack Connect channels that are
					approved for Datamate answers.
				</Text>
			</div>
