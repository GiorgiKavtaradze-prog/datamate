...
import type { TFlag } from "@datamate/shared/flags";
import { flagFormSchema } from "@datamate/shared/flags";
...
import { Button, Divider, Field, Input, Text, Textarea } from "@datamate/ui";
import { Accordion, LineSlider, Sheet, Switch } from "@datamate/ui/client";
...
function ImplementationExamples({
	...
	const codeExamples = useMemo(() => {
		...
		const basicExample = `import { useFlag } from '@datamate/sdk/react';
...
function MyComponent() {
  ...
  return on ? <NewFeature /> : <OldFeature />;
		...
		const ssrExample = `import { useFlag } from '@datamate/sdk/react';
...
function MyComponent() {
  ...
  return on ? <NewFeature /> : <OldFeature />;
		...
		const variantExample = `import { useFlag } from '@datamate/sdk/react';
	...
	return (
		<div className="space-y-3">
			<p className="text-muted-foreground text-xs">
				Use the Datamate SDK to check this flag in your app.
			</p>
