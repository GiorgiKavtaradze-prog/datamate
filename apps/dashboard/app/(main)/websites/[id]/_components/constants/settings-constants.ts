...
export const INSTALL_COMMANDS = {
	[PACKAGE_MANAGERS.NPM]: "npm install @datamate/sdk",
	[PACKAGE_MANAGERS.YARN]: "yarn add @datamate/sdk",
	[PACKAGE_MANAGERS.PNPM]: "pnpm add @datamate/sdk",
	[PACKAGE_MANAGERS.BUN]: "bun add @datamate/sdk",
} as const;
...
export const DOCUMENTATION_URLS = {
	...
	API: "https://www.datamate.cc/docs/api",
} as const;
