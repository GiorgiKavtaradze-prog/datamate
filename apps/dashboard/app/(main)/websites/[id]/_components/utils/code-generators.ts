...
export function generateScriptTag(
	...
	const scriptFile = versionedScript ? versionedScript.filename : "datamate.js";
...
export function generateNpmCode(
	...
	return `import { Datamate } from '@datamate/sdk/react';
...
export function generateNodeCode(websiteId: string): string {
	return `import { Datamate } from '@datamate/sdk/node';

const analytics = new Datamate({
