...
import { insightDefinitionEditChangesSchema } from "@datamate/shared/insights";
...
import { ArrowClockwiseIcon, PlusIcon, TargetIcon } from "@datamate/ui/icons";
	...
	useEffect(() => {
		...
		if (!goal) {
			...
			if (proposal.success) {
				...
				toast.error("Datamate's suggested changes could not be loaded");
			}
		} else {
