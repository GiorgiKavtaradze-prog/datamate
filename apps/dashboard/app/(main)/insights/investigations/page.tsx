...
import { Card, Button, EmptyState } from "@datamate/ui";
import { LightbulbIcon } from "@datamate/ui/icons";
import {
	InvestigationRow,
...
function InvestigationList({
		...
		return (
			<div className="px-5 py-12">
				<EmptyState
					...
					description="Datamate couldn't load recent investigations."
	...
	if (insights.length === 0) {
		return (
			<div className="px-5 py-12">
				<EmptyState
					description="Datamate starts an investigation when it finds a question or fix worth following through."
					icon={<LightbulbIcon weight="duotone" />}
