					...
					<Sheet onOpenChange={setSheetOpen} open={sheetOpen}>
						...
						<Sheet.Content>
							...
							<Sheet.Body className="flex flex-col gap-4">
								<Field>
									<Field.Label>Name</Field.Label>
									<Input defaultValue="datamate.cc" />
								</Field>
								<Field>
					...
					{active === "general" && (
						<div className="flex flex-col gap-6">
							...
							<Field>
								...
								<Textarea defaultValue="Building Datamate — privacy-first analytics for the modern web." />
								<Field.Description>
	...
	return (
		<div className="mx-auto flex w-full max-w-2xl flex-col gap-8">
			<div className="flex flex-col items-center gap-2 text-center">
				<Text variant="display">Welcome to Datamate</Text>
					...
					<Card.Content className="flex flex-col gap-6 p-6">
						...
						<div className="relative rounded-lg bg-muted/50 p-4 pr-12">
							<Text className="break-all" mono variant="caption">
								{
									'<script defer src="https://cdn.datamate.cc/tracker.js" data-client-id="ck_live_abc123"></script>'
								}
							</Text>
							<CopyButton
								className="absolute top-2 right-2"
								value='<script defer src="https://cdn.datamate.cc/tracker.js" data-client-id="ck_live_abc123"></script>'
							/>
						</div>
						<Divider />
						<div className="flex flex-col gap-1">
						...
						<div className="relative rounded-lg bg-muted/50 p-4 pr-12">
							...
							<CopyButton
								className="absolute top-2 right-2"
								value="npm install @datamate/sdk"
							/>
						</div>
