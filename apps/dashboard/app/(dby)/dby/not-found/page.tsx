...
import { LinkBreakIcon } from "@datamate/ui/icons";
import { Button } from "@datamate/ui";

export const metadata: Metadata = {
	title: "Link Not Found - Datamate",
		...
		<div className="flex min-h-dvh flex-col bg-background">
			<header className="mx-auto flex w-full max-w-5xl items-center p-6">
				<Link
					...
					href="https://datamate.cc"
				>
					<Branding priority variant="primary-logo" />
					<span className="font-semibold text-sm">Datamate</span>
				</Link>
			</header>
			...
			<main className="flex flex-1 flex-col items-center justify-center px-6">
				<div className="flex w-full max-w-sm flex-col items-center">
					...
					<Button asChild className="w-full" variant="outline">
						<Link href="https://datamate.cc">Learn about Datamate</Link>
					</Button>
				</div>
			</main>
