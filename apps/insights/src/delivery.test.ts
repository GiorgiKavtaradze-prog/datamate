...
const goalInvestigation: WebsiteInvestigation = {
	...
	outcome,
	signal,
	websiteDomain: "app.datamate.cc",
	websiteId: "site-1",
	websiteName: "Datamate",
};
...
describe("Slack investigation delivery", () => {
	...
	it("renders one actionable investigation", () => {
		...
		expect(blocks[0]?.text?.text).toContain("Datamate (app.datamate.cc)");
		...
		expect(fallback).toContain("app.datamate.cc");
