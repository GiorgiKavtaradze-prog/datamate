import { executeQuery } from "@datamate/ai/query";
import { and, db, eq, isNull, lte, sql } from "@datamate/db";
import { funnelDefinitions, goals, websites } from "@datamate/db/schema";
