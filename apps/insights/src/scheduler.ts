import { and, asc, db, eq, lte } from "@datamate/db";
import { insightGenerationConfigs } from "@datamate/db/schema";
import { queueInsightGenerationRun } from "@datamate/rpc/insight-generation";
import {
	getNextInsightRunAt,
	normalizeInsightScheduleFrequency,
} from "@datamate/rpc/insight-schedule";
import {
	getInsightsQueue,
