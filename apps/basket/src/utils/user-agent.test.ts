...
vi.mock("@datamate/shared/bot-detection/detector", () => ({
	detectBot: mockDetectBotShared,
}));
vi.mock("@datamate/shared/bot-detection/user-agent", () => ({
	parseUserAgent: mockParseUserAgentShared,
}));
vi.mock("@datamate/shared/bot-detection/types", async (importOriginal) => ({
