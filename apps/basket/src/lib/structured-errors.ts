...
const BASKET_ERROR_SPEC = {
	...
	INGEST_MISSING_CLIENT_ID: {
		...
		status: 400,
		why: "No client_id query parameter or datamate-client-id header was sent.",
		fix: "Pass client_id in the query string or set the datamate-client-id header.",
	},
	...
	WEBHOOK_ENDPOINT_NOT_FOUND: {
		...
		fix: "Use the webhook URL configured in Datamate.",
	},
	...
	WEBHOOK_PROCESSING_FAILED: {
		...
		status: 500,
		why: "Datamate could not persist the provider event.",
...
export function deliveryUnavailable(cause: unknown) {
	return createError({
		...
		status: 503,
		why: "Datamate could not durably accept the event.",
